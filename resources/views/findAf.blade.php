...
<table align="center">
<br><br><br><br><p><a style="font-size:30px;color:#00CED1;   ">Affiliate Details</a></p>
        ...
        <tr>
          ...
          @foreach ($Affiliate as $user)
            <tr>
            <td><a class="td">{{ $user->username }}</a></td>
            ...
            <td><a class="td">{{ $user->dob }}</a></td>
            <td><a class="td">{{ $user->referral }}</a></td>
 ...
 <input type = "hidden" name="affiliateid" value = "{{ $user->id }}"/>
  <div class="dropdown-content">
    <a href="">Edit</a>
    <a href="#">Purchase</a>
    <a href="#">Rewards</a>
</td>
<td><button class="dropbtn" ><a href=''>DELETE</a></button></td>  </div>
</div>
 </div></div>
</tr>
